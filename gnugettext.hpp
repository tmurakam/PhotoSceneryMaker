...
public:
	...
	void __fastcall GetListOfLanguages(AnsiString domain, Classes::TStrings* list);
...
protected:
	...
	virtual void __fastcall WhenNewLanguage(AnsiString LanguageID);
	virtual void __fastcall WhenNewDomain(AnsiString TextDomain);
	virtual void __fastcall WhenNewDomainDirectory(AnsiString TextDomain, AnsiString Directory);
...
extern PACKAGE void __fastcall RemoveDomainForResourceString(AnsiString domain);
